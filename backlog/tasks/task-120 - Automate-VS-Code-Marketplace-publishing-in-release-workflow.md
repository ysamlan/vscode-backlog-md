...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 VSCE_PAT secret configured in GitHub repository
- [ ] #2 Release workflow publishes to VS Code Marketplace via vsce
- [ ] #3 Secrets documented in README or CONTRIBUTING
- [ ] #4 Workflow tested with a dry-run or pre-release publish
- [ ] #5 Optionally: publish to Open VSX Registry
<!-- AC:END -->
