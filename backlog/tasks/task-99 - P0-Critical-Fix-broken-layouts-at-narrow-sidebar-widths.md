...
- [ ] #3 P0-3: List view columns don't clip at 300px — hide Actions column and move buttons to context menu, use color-only dots for priority at narrow widths (styles.css:626+)
<!-- AC:END -->
